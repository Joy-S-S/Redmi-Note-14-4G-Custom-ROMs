...
const debloatData = {
    google: [
        ...
        { name: "Gboard", package: "com.google.android.inputmethod.latin", description: "Keyboard app" },
    ...
    xiaomi: [
        ...
        { name: "Xiaomi AI Engine", package: "com.xiaomi.aicr", description: "AI services" },
        ...
        { name: "Theme Manager", package: "com.android.thememanager", description: "Theme customization" },
        { name: "Tencent Wallet", package: "com.tencent.soter.soterserver", description: "Payment service" },
        { name: "App Installer", package: "com.miui.global.packageinstaller", description: "App installation" },
        ...
        { name: "Screen Recorder", package: "com.miui.screenrecorder", description: "Screen recording" },
        { name: "MIUI System Launcher", package: "com.miui.system", description: "System launcher" },
        ...
        { name: "Mi Calendar", package: "com.xiaomi.calendar", description: "Calendar app" },
        ...
        { name: "Messages", package: "com.xiaomi.mircs", description: "Messaging app" },
        { name: "Mi Payment", package: "com.xiaomi.payment", description: "Payment service" },
        { name: "Scanner", package: "com.xiaomi.scanner", description: "QR code scanner" }
    ],
    ...
    facebook: [
        ...
        { name: "Facebook System", package: "com.facebook.system", description: "Facebook system" }
    ],
